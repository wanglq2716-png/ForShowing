...
globalThis.__MOCK_DATA__ = {
  ...
  all: {
    ...
    climate: {
      tag: "上半年趋势",
      headline: "拉尼娜背景 + 西太副高偏强，可能导致上半年降雨量呈“先偏少后偏多”趋势。",
      sub: "山东/河北：春季降雨略偏少，6 月后降雨集中度上升（示意）。",
      rain_trend: [
        { m: "1月", v: 0.88 },
        { m: "2月", v: 0.92 },
        { m: "3月", v: 0.96 },
      ...
      rain_note: "上半年累计降雨量：较常年偏多 6%（示意）",
      items: [
        { phenomenon: "拉尼娜残余信号", impact: "冷暖气流交汇频繁，降雨时段更集中。" },
        { phenomenon: "西太副高偏强", impact: "雨带北抬，山东/河北降雨偏多风险上升。" },
        { phenomenon: "东亚夏季风偏强", impact: "对流活跃，短时强降雨概率增加。" }
      ]
    },
    trend_weeks: [
    ...
    alerts: [
      {
        ...
        window: "未来 10-18 天",
        probability: 0.76,
        desc: "受副高偏强影响，连阴雨概率上升，需关注病害与田间管理压力。"
      },
      {
        id: "A-002",
        severity: "mid",
        ...
        window: "未来 7-15 天",
        probability: 0.62,
        desc: "短时强降雨集中度上升，排水能力弱区域需关注渍涝风险。"
      },
      {
        id: "A-003",
        severity: "low",
    ...
    drivers: [
      { name: "西太副高偏强", dir: "雨带北抬，华北降雨偏多", evidence: "副高强度指数偏强（示意）" },
      { name: "拉尼娜残余信号", dir: "冷暖气流交汇频繁", evidence: "太平洋海温距平偏低（示意）" },
      { name: "季风指数偏高", dir: "对流活跃，短时强降雨概率增加", evidence: "6 月降雨集中度上升（示意）" }
    ],
    advice: [
  ...
  weather: {
    ...
    temperature: {
      unit: "℃",
      provinces: [
        { name: "山东", values: [27.4, 26.8, 24.9] },
        { name: "河北", values: [26.5, 26.1, 23.6] },
        { name: "辽宁", values: [23.2, 22.6, 20.4] }
      ]
    },
    precipitation: {
      unit: "mm",
      provinces: [
        { name: "山东", values: [162, 148, 135] },
        { name: "河北", values: [138, 126, 118] },
        { name: "辽宁", values: [122, 110, 96] }
      ]
    },
    temp_anomaly_high: {
      provinces: [
        { name: "山东", values: [0.28, 0.24, 0.18] },
        { name: "河北", values: [0.22, 0.21, 0.16] },
        { name: "辽宁", values: [0.14, 0.16, 0.12] }
      ]
    },
    temp_anomaly_low: {
      provinces: [
        { name: "山东", values: [0.12, 0.15, 0.2] },
        { name: "河北", values: [0.18, 0.2, 0.24] },
        { name: "辽宁", values: [0.22, 0.25, 0.28] }
      ]
    },
    extreme_precip: {
      provinces: [
        { name: "山东", values: [0.21, 0.26, 0.19] },
        { name: "河北", values: [0.24, 0.28, 0.22] },
        { name: "辽宁", values: [0.17, 0.2, 0.16] }
      ]
    }
  },
  regions: {
